...
namespace DatabaseDesign.Controllers
{
    public class InformationController : Controller
    {
        ...
        public InformationController(DatabaseDesignContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Information != null ? 
                          ...
                          Problem("Entity set 'DatabaseDesignContext.Information'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Address,location")] Information information)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Address,location")] Information information)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DatabaseDesignContext.Information'  is null.");
            }
            var information = await _context.Information.FindAsync(id);
            if (information != null)
            {
